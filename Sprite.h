...
namespace TRXEngine 
{
	...
	{
	public:
		Sprite(glm::vec4 pos_and_dim, const std::string& path_to_texture, glm::vec4 uv_rec = { 0.0f,0.0f,1.0f,1.0f }, float depth = 1.0f, TRXEngine::Color color = { 255,255,255,255 });
		~Sprite();
